...
changed_salaries <- runif(100, -5000, 10000)
...
# 2017 and 2018
salaries$change <- changed_salaries - random_salaries
...
salary_57 <- salaries[salaries$employees == "Employee 57", "changed_salaries"]
